...
import TheTrends from '@/apps/social/posts/components/TheTrends.vue'
import TheSocialPostCard from '@/apps/social/posts/components/TheSocialPostCard.vue'
import TheCreatePostForm from '@/apps/social/posts/components/TheCreatePostForm.vue'
