            ...
            <v-card class="mb-5 mx-auto" max-width="800">
                <div v-if="cartTotalLength">
                    ...
                    <v-table fixed-header hover density="comfortable">
                        ...
                        <tbody>
                            <TheCartItem v-for="item in cart.items" v-bind:key="item.product.id" v-bind:initialItem="item"
                    ...
                    <v-card-actions>
                        <div class="d-flex justify-end">
                            <v-btn variant="flat" color="success" class="mr-4" to="/cart/checkout">
                                Proceed to checkout
                            </v-btn>
                        </div>
                    </v-card-actions>
                </div>
                <v-card-title v-else>You don't have any products in your cart...</v-card-title>
            </v-card>
        </v-container>
    </v-main>
</template>
