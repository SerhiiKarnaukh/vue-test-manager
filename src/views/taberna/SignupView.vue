      ...
      <v-card-text>
        <v-form @submit.prevent="registerHandler">
          ...
          <v-text-field
            ...
            label="First Name"
            name="taberna_signup_given_name"
          ...
          <v-text-field
            ...
            label="Last Name"
            name="taberna_signup_family_name"
          ...
          <v-text-field
            ...
            :type="state.showPassword ? 'text' : 'password'"
            name="taberna_signup_password_confirm"
            autocomplete="new-password"
            clearable
