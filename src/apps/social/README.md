...
src/apps/social/
├── README.md
├── social_network_main.jpg
├── components/                   # TheNavbar, TheFooter
├── layouts/
│   └── MainSocialLayout.vue      # Layout wrapper (navbar + footer)
├── posts/
│   ├── api/                      # feed, posts, search, trends, actions
│   ├── store/posts.module.js
│   ├── views/                    # Home, Post, Search, Trend
│   └── components/               # TheCreatePostForm, TheSocialPostCard, TheTrends, TheCommentItem
├── profiles/
│   ├── api/                      # profile, friendship
│   ├── store/profiles.module.js
│   ├── views/                    # Login, Signup, Profile, Friends, Edit*
│   └── components/               # ThePeopleYouMayKnow
├── chat/
│   ├── api/chat.js
│   ├── store/chat.module.js
│   └── views/ChatView.vue
└── notifications/
...
src/store/index.js                # registers social* modules from apps/social/*/store/
```
...
- [Social app modules](https://github.com/SerhiiKarnaukh/vue-test-manager/tree/main/src/apps/social)
- [Shared social components](https://github.com/SerhiiKarnaukh/vue-test-manager/tree/main/src/components/social)
- [Social Vuex modules](https://github.com/SerhiiKarnaukh/vue-test-manager/tree/main/src/apps/social)
