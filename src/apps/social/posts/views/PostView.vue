...
<script>
import ThePeopleYouMayKnow from '@/apps/social/profiles/components/ThePeopleYouMayKnow.vue'
import TheTrends from '../components/TheTrends.vue'
import TheSocialPostCard from '../components/TheSocialPostCard.vue'
import TheCommentItem from '@/apps/social/posts/components/TheCommentItem.vue'
