...
├── README.md
├── ai_lab_main.jpg
├── layouts/MainAILabLayout.vue   # Navbar + footer + realtime WS init
├── api/                          # chat, image, voice, realtime
├── store/aiLab.module.js
├── views/                        # Home, Image, Voice, RealtimeChat
└── components/                   # TheNavbar, TheFooter, ThePromptForm, TheRealTimeChat

src/store/index.js                # registers aiLabChatData from apps/ai_lab/store/
```
...
- [AI Lab app](https://github.com/SerhiiKarnaukh/vue-test-manager/tree/main/src/apps/ai_lab)
- [AI Lab Vuex Store](https://github.com/SerhiiKarnaukh/vue-test-manager/tree/main/src/apps/ai_lab/store)
